...
class Settings(BaseSettings):
    ...
    db_statement_timeout_ms: int = Field(default=0, alias="DB_STATEMENT_TIMEOUT_MS")
    matching_batch_size: int = Field(default=100, alias="MATCHING_BATCH_SIZE")
    matching_max_retries: int = Field(default=3, alias="MATCHING_MAX_RETRIES")
